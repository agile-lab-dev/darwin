...
#### sbt
```scala
libraryDependencies += "it.agilelab" %% "darwin-core" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
...
#### sbt
```scala
libraryDependencies += "it.agilelab" %% "darwin-hbase-connector" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
...
```scala
libraryDependencies += "it.agilelab" %% "darwin-postgres-connector" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
...
```scala
libraryDependencies += "it.agilelab" %% "darwin-rest-connector" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
...
```scala
libraryDependencies += "it.agilelab" %% "darwin-mock-connector" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
...
```scala
libraryDependencies += "it.agilelab" %% "darwin-confluent-connector" % "1.1.1-SNAPSHOT"
``` 
#### maven
```xml
<dependency>
