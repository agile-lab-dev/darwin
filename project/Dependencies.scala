...
object Dependencies {
  ...
  lazy val hbase_client = "org.apache.hbase" % "hbase-client" % "1.2.2" % "provided"
  ...
  lazy val mock_app_dep = core_deps ++ Seq(reflections, hbase_common, hbase_server)
  lazy val mock_conn = core_deps ++ Seq(reflections)
  lazy val hbase_conn_dep = core_deps ++ Seq(hbase_common, hbase_client, hadoop_common)
